...
def parse_args():
    ...
    parser.add_argument(
        '--data_cfg_path', type=str, default="configs/data/megadepth_trainval_640.py", help='data config path')
    parser.add_argument(
        '--main_cfg_path', type=str, default="configs/loftr/outdoor/loftr_ds_dense.py", help='main config path')
    parser.add_argument(
        '--exp_name', type=str, default='rebuttal-1')
    parser.add_argument(
    ...
    parser.add_argument(
        '--ckpt_path', type=str, default='D:\LoFTR-master-scalenet\logs\\tb_logs\原模型-调参\\version_0\checkpoints\epoch=1-auc@5=0.484-auc@10=0.650-auc@20=0.779.ckpt',
...
def main():
    ...
    args.flush_logs_every_n_steps = 1
