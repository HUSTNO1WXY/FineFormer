...
In Table 1 and Table 2, the AUC scores for some entries (shown in red) are repeated. The same story goes for our [another work](https://ieeexplore.ieee.org/document/10485434). Here we make the correction:
